 ...
 */
public class CardPlay extends RecyclableCard {

    public CardPlay(String titlePlay, String description, String color,
    ...
    protected void applyTo(View convertView) {
        ...
        if (isClickable == true)
            ((LinearLayout) convertView.findViewById(R.id.contentLayout))
                    .setBackgroundResource(R.drawable.selectable_background_mycareer);
